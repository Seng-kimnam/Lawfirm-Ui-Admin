...
const AddCase = () => {
  ...
  // const { option, loading, error } = useServiceOptions();
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        const response = await request("/expertises/without-pagination", "GET");

        setExpertises(response?.payload || []);
      } catch (error) {
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    {expertises?.map(({ expertiseId, expertName }) => (
                      <SelectItem key={expertiseId} value={expertName}>
                        {expertName}
                      </SelectItem>
                    ))}
                  </SelectGroup>
